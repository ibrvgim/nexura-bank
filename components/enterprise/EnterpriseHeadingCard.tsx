...
function EnterpriseHeadingCard() {
  return (
    <div>
      <p className="mx-auto w-[80%] text-center text-7xl font-extrabold text-gray-700 uppercase">
      ...
      <p className="mx-auto my-8 w-1/2 text-center text-lg tracking-wide">
        ...
        next-generation payment solutions. Deliver the experiences customers
